        ...
        protected void rptTaskAvviati_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                if (id != -1)
                {
                    ...
                    TimeZoneInfo tzInfo = rp.tzFusoOrario;
                    ...
                    if (tRow != null)
                    {
                        ...
                        else if (tsk.LateFinish <= TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, tzInfo))
                        {
                            tRow.BgColor = "#FF0000";
                            tRow.Attributes.Add("onMouseOut", "this.style.backgroundColor='#FF0000'");
                        }
                        else if (tsk.EarlyFinish <= TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, tzInfo))
                        {
                            tRow.BgColor = "#FFFF00";

...
<asp:Repeater runat="server" ID="rptArticoli" OnItemDataBound="rptArticoli_ItemDataBound" OnItemCommand="rptArticoli_ItemCommand">
    <HeaderTemplate>
      ...
      <asp:Image ID="Image16" ImageUrl="~/img/iconArrowDown.png" alt="Descending" runat="server" height="20" Width="12" />
                    ...
                    <th>Data fine produzione<br /><asp:LinkButton ID="lnkDataFineProdUp" runat="server" onclick="lnkDataFineProdUp_Click">
            ...
            <ItemTemplate>
                <tr runat="server" id="tr1" style="font-size:14px; font-family:Calibri">
                    <td><asp:HyperLink Width="40" runat="server" ID="lnkStatoArticolo" NavigateUrl='<%# "statoAvanzamentoArticolo.aspx?id=" + DataBinder.Eval(Container.DataItem, "ID") + "&anno=" + DataBinder.Eval(Container.DataItem, "Year") %>' Target="_blank">
                            <asp:Image runat="server" ID="imgStatoArticolo" ImageUrl="/img/iconView.png" ToolTip="Visualizza lo stato di avanzamento dell'articolo" />
                        </asp:HyperLink></td>
                    <td>
                        <asp:ImageButton runat="server" ID="imgPrintOrdini" ImageUrl="/img/iconBarcode.png" Width="20" Height="20" CommandName="printOrdini" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + ";" + DataBinder.Eval(Container.DataItem, "Year") %>' ToolTip="Stampa barcode su fogli multipli" /><br />
                        <asp:ImageButton runat="server" ID="imgPrintOrdini2" ImageUrl="/img/iconBarcode.png" Height="20" CommandName="printOrdini" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + ";" + DataBinder.Eval(Container.DataItem, "Year") %>' ToolTip="Stampa barcode su fogli multipli" />
                    </td>
                    <td>
                        <asp:ImageButton runat="server" ID="imgPrintOrdiniSingolo" ImageUrl="/img/iconBarcode.png" Width="40" Height="40" CommandName="printOrdiniSingolo" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + ";" + DataBinder.Eval(Container.DataItem, "Year") %>' ToolTip="Stampa barcode foglio singolo" />
                    </td>
                    <td>
                        <asp:ImageButton runat="server" ID="imgPrintOrdiniSingoloA3" ImageUrl="/img/iconA3.gif" Width="40" Height="40" CommandName="printOrdiniSingoloA3" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + ";" + DataBinder.Eval(Container.DataItem, "Year") %>' ToolTip="Stampa barcode foglio singolo formato A3" />
                    </td>
                    <td><asp:hyperlink runat="server" ID="lnkPrintKanbanCard" NavigateUrl='<%# "https://app.kanbanbox.com/printer/print_ekanban/"+DataBinder.Eval(Container.DataItem, "KanbanCardID") %>' ToolTip="Stampa il cartellino kanban" Target="_blank">
                ...
                <td><%# ((DateTime)DataBinder.Eval(Container.DataItem, "DataPrevistaConsegna")).ToString("dd/MM/yyyy") %></td>
                    ...
                    <td>
                        <asp:HyperLink Width="40" runat="server" ID="lnkRipianifica" NavigateUrl="/Commesse/wzAssociaPERTReparto.aspx" Target="_blank">
                            <asp:Image runat="server" ID="imgRipianifica" ImageUrl="~/img/iconChangePlan.png" Height="40" ToolTip="Ripianifica la produzione del prodotto!" Visible="false" />
                        </asp:HyperLink>
                    </td>
                </tr>
            </ItemTemplate>

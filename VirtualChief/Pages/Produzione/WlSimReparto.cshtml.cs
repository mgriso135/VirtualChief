...
{
    public class WlSimRepartoModel : PageModel
    {
        private readonly ILogger<WlSimRepartoModel> _logger;

        public WlSimRepartoModel(ILogger<WlSimRepartoModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavWlSimReparto { get; private set; } = "Simulazione Carico di Lavoro Reparto";
        ...
        public void OnGet(int id)
        {
            ...
            {
                _logger.LogError(ex, "WlSimReparto/OnGet");

...
{
    public class WorkLoadRepartiModel : PageModel
    {
        private readonly ILogger<WorkLoadRepartiModel> _logger;

        public WorkLoadRepartiModel(ILogger<WorkLoadRepartiModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavWorkLoadReparti { get; private set; } = "Carico di Lavoro Reparti";
        ...
        public void OnGet()
        {
            ...
            {
                _logger.LogError(ex, "WorkLoadReparti/OnGet");

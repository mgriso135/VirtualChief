...
<table class="table table-striped table-hover table-condensed">
    <tr>
        <td><asp:Label runat="server" ID="lblDescNome" meta:resourcekey="lblDescNome" /></td>
        <td><b><asp:Label runat="server" ID="lblNome" />
            <asp:TextBox runat="server" ID="txtNome" /></b>
        </td>
    ...
    <tr>
        <td><asp:Label runat="server" ID="lblDescCognome" meta:resourcekey="lblDescCognome" /></td>
        <td><b><asp:Label runat="server" ID="lblCognome" />
            <asp:TextBox runat="server" ID="txtCognome" /></b>
        </td>

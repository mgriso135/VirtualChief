    ...
    public static class UserMenu
    {
        ...
        private static readonly Dictionary<string, string> PageMap =
            new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["pianoproduzionecompleto"] = "/Produzione/PianoProduzioneCompleto",
                // Produzione - new migrated pages
                ["listcommesseStatoN"] = "/Produzione/CommesseDaProdurre",
                ["listarticoliterminati"] = "/Produzione/StoricoProduzione",
                ["listwarningaperti"] = "/Produzione/ListWarningAperti",
                ["listwarningapertireparto"] = "/Produzione/ListWarningApertiReparto",
                ["liststatusutentiReparto"] = "/Produzione/ListStatusUtentiReparto",
                ["showproduttivitareparto"] = "/Produzione/ShowProduttivitaReparto",
                ["statoavanzamentoarticolo"] = "/Produzione/StatoAvanzamentoArticolo",
                ["articolistatoi"] = "/Produzione/ArticoliStatoI",
                ["articolistatoiAndonReparto"] = "/Produzione/ArticoliStatoIAndonReparto",
                ["configprocessoperproduzione"] = "/Produzione/ConfiguraProcesso",
                ["solvecproblem"] = "/Produzione/SolveProblem",
                ["solveproblem"] = "/Produzione/SolveProblem",
                ["avanzamentoproduzione"] = "/Produzione/AvanzamentoProduzione",
                ["wlReparto"] = "/Produzione/WlReparto",
                ["wlSimReparto"] = "/Produzione/WlSimReparto",
                ["workLoadListReparti"] = "/Produzione/WorkLoadListReparti",
                ["workLoadSimReparti"] = "/Produzione/WorkLoadSimReparti",
                ["productionPlan"] = "/Produzione/ProductionPlan",
                ["viewDetailstask"] = "/Produzione/ViewDetailsTask",
                ["viewDetailstaskProduzione"] = "/Produzione/ViewDetailsTaskProduzione",
                ["storicoproduzione"] = "/Produzione/StoricoProduzione",
                ["configuraprocesso"] = "/Produzione/ConfiguraProcesso",
            };

...
<asp:Repeater runat="server" ID="rptOrari" OnItemCommand="rptOrari_ItemCommand" OnItemCreated="rptOrari_ItemDataBound">
    <HeaderTemplate>
        <table>
            ...
            <tr>
                <th></th>
                <th><asp:Literal runat="server" ID="lblGiornoInizio" Text="<%$Resources:lblGiornoInizio %>" /></th>
                <th><asp:Literal runat="server" ID="lblOraInizio" Text="<%$Resources:lblOraInizio %>" /></th>
                <th><asp:Literal runat="server" ID="lblGiornoFine" Text="<%$Resources:lblGiornoFine %>" /></th>
                <th><asp:Literal runat="server" ID="lblOraFine" Text="<%$Resources:lblOraFine %>" /></th>
                <th><asp:Literal runat="server" ID="lblDurataTurno" Text="<%$Resources:lblDurataTurno %>" /></th>
            </tr>
                </thead>
    </HeaderTemplate>
    <ItemTemplate>

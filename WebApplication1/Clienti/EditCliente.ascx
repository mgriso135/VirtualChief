...
<table runat="server" id="tblData" class="table table-striped table-hover">
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="txtPIva" MaxLength="11" ValidationGroup="salva" />
            <asp:CustomValidator ID="valPIva" runat="server" ControlToValidate="txtPIva" ForeColor="Red" ErrorMessage="<%$Resources:req11Length %>" OnServerValidate="valPIva_ServerValidate" ValidationGroup="salva" />
        </td>
    </tr>
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="txtCodFiscale" ValidationGroup="salva" MaxLength="16" />
             <asp:CustomValidator ID="valCodFiscale" runat="server" ControlToValidate="txtCodFiscale" ForeColor="Red" ErrorMessage="<%$Resources:req16Length %>" OnServerValidate="valCodFiscale_ServerValidate" ValidationGroup="salva" />
        </td>
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="txtProvincia" Width="20" MaxLength="2" ValidationGroup="salva" />
            <asp:CustomValidator ID="valProvincia" runat="server" ControlToValidate="txtProvincia" ForeColor="Red" ErrorMessage="<%$Resources:req2Length %>" OnServerValidate="valProvincia_ServerValidate" ValidationGroup="salva" />
        </td>
    </tr>
    <tr>

...
<b><asp:Label runat="server" ID="lblAddNewTask" Text="<%$Resources:lblAddNewTask %>" /></b>&nbsp;
            <img ID="imgAddTaskPert" src="../img/iconAdd.jpg" style="min-width:20px; max-width: 40px; height:40px; cursor: pointer" Height="40" />
            </td>
            </tr>
    <tr>
        <td>
...
<img src="../img/iconSave.jpg" style="height:40px; cursor: pointer" id="linkExistingTask" />
            </td>
        </tr>
</table>
  ...
  <asp:label runat="server" ID="svg1">
   ...
   <script lang="javascript">
       ...
       function stop_dragging(evt, taskID) {
           start_drag = 0;
           var popup = window.open("../Processi/updatePERT.aspx?id=" + taskID + "&act=updatepos&posx=" + $('#task' + taskID).attr('cx') + "&posy=" + $('#task' + taskID).attr('cy') + "&variante=" + varID, null, "height=5,width=5");
           popup.blur();
           window.focus();
           drawLines();
       }
       ...
       $(document).ready(function () {
           ...
           $('#linkExistingTask').click(function () {
               procID = getQueryStringValue("idProc");
               varID = getQueryStringValue("idVariante");
               rev = getQueryStringValue("revProc");
...
width: 100%; height:1000px; z-index:100; vertical-align:middle; border: 1px solid black;">
        <table style="position: relative; top: 0px; left: 20%; background-color: white; border: 1px dashed black;">
            <tr><td style="text-align: right;">
                ...
                <img src="../img/iconClose.png" style="height: 20px; text-align:right;" id="imgCloseEdit"  />
                </td></tr>
            <tr>
                <td>

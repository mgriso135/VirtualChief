...
{
    public class WorkLoadListRepartiModel : PageModel
    {
        private readonly ILogger<WorkLoadListRepartiModel> _logger;

        public WorkLoadListRepartiModel(ILogger<WorkLoadListRepartiModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavCapacitaProduzione { get; private set; } = "Capacità di Produzione";
        ...
        public void OnGet()
        {
            ...
            {
                _logger.LogError(ex, "WorkLoadListReparti/OnGet");

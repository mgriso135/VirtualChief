    ...
    <script lang="javascript">
        ...
        function controllo1() {
            ...
            if (azione == "I" || azione == "A" || azione == "W" || azione == "F" || azione == "P" || azione == 'B') {
                ...
                var usr2 = tbox.value.substring(1, tbox.value.length);
                var split = usr2.split(';');
                var usr = split[1];
                var checksum = split[0];
...
<body>
    ...
    <div>
    <asp:TextBox Font-Size="3" runat="server" ID="box1" onchange="controllo1()" AutoCompleteType="Disabled" />
        <asp:TextBox Font-Size="3" runat="server" ID="box2" onchange="controllo2()" AutoCompleteType="Disabled" />
        <br/>

...
<asp:Repeater runat="server" ID="rptFigli" OnItemCommand="rptFigli_ItemCommand" OnItemDataBound="rptFigli_ItemDataBound">
    ...
    <ItemTemplate>
        <tr runat="server" id="tr1">
            ...
            <td><asp:ImageButton runat="server" ID="btnEdit" ImageUrl="/img/edit.png" ToolTip="Modifica la voce di menu" class="btn btn-primary" Height="20" CommandName="edit" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") %>' /></td>
            <td>
                <asp:ImageButton runat="server" ID="btnDelete" ImageUrl="/img/iconDelete.png" ToolTip="Cancella la voce di menu" class="btn btn-primary" Height="20" CommandName="delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") %>' />
            </td>

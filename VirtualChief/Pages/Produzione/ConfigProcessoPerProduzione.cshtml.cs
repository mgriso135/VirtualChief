...
{
    public class ConfigProcessoPerProduzioneModel : PageModel
    {
        private readonly ILogger<ConfigProcessoPerProduzioneModel> _logger;

        public ConfigProcessoPerProduzioneModel(ILogger<ConfigProcessoPerProduzioneModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavConfigProcesso { get; private set; } = "Configurazione Processo per Produzione";
        ...
        public void OnGet(int id, int anno)
        {
            ...
            {
                _logger.LogError(ex, "ConfigProcessoPerProduzione/OnGet");

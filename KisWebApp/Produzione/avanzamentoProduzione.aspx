<%@ Page Title="Virtual Chief" Language="C#" AutoEventWireup="true" CodeBehind="avanzamentoProduzione.aspx.cs" Inherits="KIS.Produzione.avanzamentoProduzione" %>
...
<input type="hidden" id="txtScrollTypeContinuousBackSpeed" runat="server" />
    ...
    <asp:Repeater runat="server" ID="rptElencoArticoliNP" OnItemDataBound="rptElencoArticoliNP_ItemDataBound">
        <HeaderTemplate>
            <table class="table table-condensed table-curved">
                <thead>
        ...
        <ItemTemplate>
            <tr runat="server" id="tr1">
                <td style="border-radius: 5px;"><asp:HyperLink runat="server" ID="lnkStatoArticolo" NavigateUrl='<%# "statoAvanzamentoArticolo.aspx?id=" + DataBinder.Eval(Container.DataItem, "ID") + "&anno=" + DataBinder.Eval(Container.DataItem, "Year") %>' Target="_blank">

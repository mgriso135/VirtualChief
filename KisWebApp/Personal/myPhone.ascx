...
<asp:UpdatePanel runat="server" ID="upd1">
    <ContentTemplate>
<asp:ImageButton Height="30" runat="server" ID="imgShowFormAddPhone" ImageUrl="~/img/iconAdd2.png" OnClick="imgShowFormAddPhone_Click" />
...
<table runat="server" id="frmAddPhone" class="table table-bordered table-hover table-condensed">
    <thead>
    <tr>
        <th><asp:label runat="server" id="lblPhoneNumber" meta:resourcekey="lblPhoneNumber" /></th>
        <th><asp:label runat="server" id="lblAmbito" meta:resourcekey="lblAmbito" /></th>
        <th><asp:label runat="server" id="lblForAlarm" meta:resourcekey="lblForAlarm" /></th>
    </tr>
        </thead><tbody>
    <tr>
        ...
        <asp:Repeater runat="server" ID="rptListPhone" OnItemCommand="rptListPhone_ItemCommand">
            <HeaderTemplate>
                <table class="table table-striped table-hover table-condensed">
                    ...
                    <tr>
                        <th></th>
                        <th><asp:label runat="server" id="lblPhoneNumber2" meta:resourcekey="lblPhoneNumber" /></th>
                        <th><asp:label runat="server" id="lblAmbito2" meta:resourcekey="lblAmbito" /></th>
                        <th><asp:label runat="server" id="lblForAlarm2" meta:resourcekey="lblForAlarm" /></th>
                    </tr>
                        </thead>
                    <tbody>
            </HeaderTemplate>

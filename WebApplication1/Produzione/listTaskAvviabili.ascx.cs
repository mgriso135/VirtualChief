    ...
    public partial class listTaskAvviabili : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ckUser == true && pst.id != -1)
            {
                if (!Page.IsPostBack)
                {
                    //lbl1.Text += "Chiamata Postazione.loadTraskProduzioneAvviabili()<br />";
                ...
                //lbl1.Text += "Fine elaborazione " + DateTime.Now.ToString("HH:mm:ss") + "<br />";
            }
            else
            {
            ...
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                if (id != -1)
                {
                    ...
                    if (tRow != null)
                    {
                        ...
                        if (tsk.LateStart <= DateTime.Now)
                        {
                            tRow.BgColor = "#FF0000";
                            tRow.Attributes.Add("onMouseOut", "this.style.backgroundColor='#FF0000'");
                        }
                        else if (tsk.EarlyStart <= DateTime.Now)
                        {
                            tRow.BgColor = "#FFFF00";

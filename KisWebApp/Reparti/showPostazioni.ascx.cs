...
namespace KIS.Produzione
{
    public partial class showPostazioni : System.Web.UI.UserControl
    {
        ...
        {
            cont = 0;
            procs = new processo(Session["ActiveWorkspace_Name"].ToString(), procID);
            procs.loadFigli(new variante(Session["ActiveWorkspace_Name"].ToString(), varID));
        ...
        protected void ddlPostazioni_IndexChanged(object sender, EventArgs e)
        {
            ...
            {
                    processo task = new processo(Session["ActiveWorkspace_Name"].ToString(), taskID);

...
{
    public class SolveProblemModel : PageModel
    {
        private readonly ILogger<SolveProblemModel> _logger;

        public SolveProblemModel(ILogger<SolveProblemModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavSolveProblem { get; private set; } = "Risolvi Problema";
        ...
        public void OnGet(int id)
        {
            ...
            try
            {
                ...
                if (int.TryParse(uidStr, out var uid))
                {
                    ...
                    if (HasPermission && IdWarning <= 0)
                    {
                        HasPermission = false;
                        ErrorMessage = "ID warning non valido";
                    }
                }
                else
                {
            ...
            {
                _logger.LogError(ex, "SolveProblem/OnGet");

        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(sTaskID) && !String.IsNullOrEmpty(sRevTaskID) && !String.IsNullOrEmpty(sVarianteID))
            {
                ...
                {                   
                    ...
                    variante vari = new variante(Session["ActiveWorkspace_Name"].ToString(), varianteID);
                    TaskVariante tsk = new TaskVariante(Session["ActiveWorkspace_Name"].ToString(), new processo(Session["ActiveWorkspace_Name"].ToString(), taskID, revTaskID), vari);

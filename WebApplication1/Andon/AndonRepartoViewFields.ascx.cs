...
namespace KIS.Andon
{
    public partial class AndonRepartoViewFields : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            prmUser[0] = "AndonReparto CampiDaVisualizzare";
            prmUser[1] = "W";
            ...
            if (checkUser == true)
            {
                if (!Page.IsPostBack)
                {
                    AndonReparto andonCfg = new AndonReparto(idReparto);
        ...
        protected void rptCampiVisualizzabili_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                if (tr != null && hID != null)
                {
                    ...
                    AndonReparto cfg = new AndonReparto(idReparto);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewPostazione.aspx.cs"
    MasterPageFile="~/Site.master" Title="Virtual Chief" Inherits="KIS.Postazioni.viewPostazione" %>
...
<%@ Register TagPrefix="postazione" TagName="edit" Src="~/Postazioni/editPostazione.ascx" %>
...
<h3><asp:Label runat="server" ID="lblNomePost" /></h3>
    ...
    <div class="accordion" id="accordion1" runat="server">
      ...
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapseFour">
          <asp:Literal runat="server" ID="lblEditPostazione" Text="<%$Resources:lblEditPostazione %>" />
      </a>
    </div>
            <div id="collapseFour" class="accordion-body collapse">
      <div class="accordion-inner">
            <postazione:edit runat="server" ID="frmEditPostazione" />
      </div>
    </div>
            </div>

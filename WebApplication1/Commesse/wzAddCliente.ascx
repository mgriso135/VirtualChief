...
<table runat="server" id="frmAddcliente" class="table table-hover table-striped">
     <tr>
        ...
        <td><asp:TextBox runat="server" ID="txtCodiceCliente" ValidationGroup="salva" />
            <asp:RequiredFieldValidator runat="server" ID="valCodiceCliente" ForeColor="Red" ErrorMessage="* Campo obbligatorio" ControlToValidate="txtCodiceCliente" ValidationGroup="salva" />
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="txtRagSoc" ValidationGroup="salva" />
            <asp:RequiredFieldValidator runat="server" ID="valRagSociale" ForeColor="Red" ErrorMessage="* Campo obbligatorio" ControlToValidate="txtRagSoc" ValidationGroup="salva" />
        </td>
    </tr>
    <tr>
        <td>Partita IVA</td>
        <td><asp:TextBox runat="server" ID="txtPartitaIVA" MaxLength="11" ValidationGroup="salva" />
            <asp:CustomValidator ID="valPIva" runat="server" ControlToValidate="txtPartitaIVA" ForeColor="Red" ErrorMessage="* Il campo deve essere lungo 11 caratteri, oppure deve essere vuoto" OnServerValidate="valPIva_ServerValidate" ValidationGroup="salva" />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><asp:TextBox runat="server" ID="txtProvincia" Width="20" MaxLength="2" ValidationGroup="salva" />
            <asp:CustomValidator ID="valProvincia" runat="server" ControlToValidate="txtProvincia" ForeColor="Red" ErrorMessage="* Il campo deve essere lungo 2 caratteri" OnServerValidate="valProv_ServerValidate" ValidationGroup="salva" />
        </td>
    </tr>
    <tr>
        <td>CAP</td>

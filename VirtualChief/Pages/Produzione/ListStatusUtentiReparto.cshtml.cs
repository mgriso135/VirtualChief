...
{
    public class ListStatusUtentiRepartoModel : PageModel
    {
        private readonly ILogger<ListStatusUtentiRepartoModel> _logger;

        public ListStatusUtentiRepartoModel(ILogger<ListStatusUtentiRepartoModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavStatusUtentiReparto { get; private set; } = "Stato Utenti Reparto";
        ...
        public void OnGet(int? id)
        {
            ...
            {
                _logger.LogError(ex, "ListStatusUtentiReparto/OnGet");

...
Segnala ritardi maggiori a Ore:<asp:DropDownList runat="server" ID="ddlOre" CssClass="dropdown" Width="70px" />&nbsp;mm:<asp:DropDownList runat="server" ID="ddlMinuti" CssClass="dropdown" Width="60px" />&nbsp;ss:<asp:DropDownList runat="server" ID="ddlSecondi" CssClass="dropdown" Width="60px" />

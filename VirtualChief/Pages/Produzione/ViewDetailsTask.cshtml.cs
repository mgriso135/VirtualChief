...
{
    public class ViewDetailsTaskModel : PageModel
    {
        private readonly ILogger<ViewDetailsTaskModel> _logger;

        public ViewDetailsTaskModel(ILogger<ViewDetailsTaskModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavViewDetailsTask { get; private set; } = "Dettagli Task";
        ...
        public void OnGet(int id)
        {
            ...
            {
                _logger.LogError(ex, "ViewDetailsTask/OnGet");

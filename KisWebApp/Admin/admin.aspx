...
<p><asp:label runat="server" id="lblGestioneUtenti" meta:resourcekey="lblGestioneUtenti" /></p>
        ...
        <li class="span2">
            <asp:HyperLink runat="server" ID="lnkMeasurementUnits" NavigateUrl="~/Config/MeasurementUnits/Index">
        <asp:Image CssClass="btn btn-primary" runat="server" ID="Image4" ToolTip="Measurement units management" Height="100" ImageUrl="~/img/iconMeasurementUnits.png" /></asp:HyperLink>
        <p><asp:label runat="server" id="Label1" meta:resourcekey="lblMeasurementUnits" /></p>
        </li>
        </ul>
        </div>
</asp:Content>

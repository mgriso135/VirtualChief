                ...
                if (repID != -1)
                {
                    ...
                    //if (!Page.IsPostBack)
                    {
                        ...
                        if (curr != -1)
                        {
                            ...
                            lblFineProgrammate.Text = "<span style=\"font-size: 12px;\">Produzione prevista:</span>&nbsp;<span style=\"font-weight:bold; font-size: 24px;\">"
...
//                                + rp.CalendarioRep.Intervalli[curr].log;
                            ...
                            lblFineAttuale.Text = "<span style=\"font-size: 12px;\">Produzione attuale:</span>&nbsp;<span style=\"font-weight:bold; font-size: 24px;\">"

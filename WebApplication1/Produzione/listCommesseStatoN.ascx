...
<h3>Righe d'ordine non programmate in produzione</h3>
...
<asp:Repeater runat="server" ID="rptStatoN" OnItemDataBound="rptStatoN_ItemDataBound" OnItemCommand="rptStatoN_ItemCommand">
    ...
    <ItemTemplate>
        <tr runat="server" id="tr1">
            <td><asp:ImageButton runat="server" ID="lnkAssegnaSN" ImageUrl="/img/iconSerialNumber1.jpg" Height="40" ToolTip="Assegna una matricola" CommandName="AssegnaMatricola" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + "/" + DataBinder.Eval(Container.DataItem, "Year") %>' />
            </td>
            ...
            <td><asp:label runat="server" ID="lblMatricola" text='<%#DataBinder.Eval(Container.DataItem, "Matricola") %>' />
                ...
                <asp:ImageButton runat="server" ID="btnSaveSN" ImageUrl="/img/iconSave.jpg" Visible="false" Height="40" ToolTip="Salva la matricola" CommandName="saveSN" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + "/" + DataBinder.Eval(Container.DataItem, "Year") %>' />
                <asp:ImageButton runat="server" ID="btnUndo" ImageUrl="/img/iconUndo.png" Visible="false" Height="40" ToolTip="Reset matricola" CommandName="resetSN" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID") + "/" + DataBinder.Eval(Container.DataItem, "Year") %>' />
            </td>

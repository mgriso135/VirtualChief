...
{
    public class ListArticoliTerminatiModel : PageModel
    {
        private readonly ILogger<ListArticoliTerminatiModel> _logger;

        public ListArticoliTerminatiModel(ILogger<ListArticoliTerminatiModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavArticoliTerminati { get; private set; } = "Articoli Terminati";
        ...
        public void OnGet(DateTime? inizio, DateTime? fine)
        {
            ...
            {
                _logger.LogError(ex, "ListArticoliTerminati/OnGet");

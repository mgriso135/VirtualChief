...
<table>
    ...
    <tr runat="server" id="trLeadTime"><td><asp:Literal runat="server" ID="Literal1" Text="<%$Resources:lblTDLeadTime %>" /></td><td><asp:Label runat="server" ID="lblLeadTime" />&nbsp;<asp:Literal runat="server" ID="Literal2" Text="<%$Resources:lblHours %>" /></td></tr>
    </table>
<br />
...
<asp:Label runat="server" ID="lblDataUpdate" />
        <asp:Repeater runat="server" ID="rptTasks" OnItemDataBound="rptTasks_ItemDataBound" OnItemCommand="rptTasks_ItemCommand">
            <HeaderTemplate>
                <table style="border:1px dashed blue">
                    <tr style="font-family: Calibri; font-size: 18px; font-weight: bold;">
                        ...
                        <td><asp:Literal runat="server" Text="<%$Resources:lblTDLeadTime %>" /></td>
            ...
            <ItemTemplate>
                <tr runat="server" id="tr1" style="font-family: Calibri; font-size: 14px;">
                    ...
                    <td>
                        ...
                        <%# ((TimeSpan)DataBinder.Eval(Container.DataItem, "WorkingTime")).TotalHours.ToString("F2") %>
                    </td>
                    ...
                    <td><%#((TimeSpan)DataBinder.Eval(Container.DataItem, "LeadTime")).TotalHours.ToString("F2")%>
                    </td>
                    <td><%#((TimeSpan)DataBinder.Eval(Container.DataItem, "Delay")).TotalHours.ToString("F2")%>
                    </td>
                    <td>
            ...
            <FooterTemplate>
                <tr>
                    <td colspan="11"><asp:label runat="server" CssClass="lead"><asp:literal runat="server" ID="lblTotale" Text="<%$Resources:lblTotale %>"/></asp:label></td>
                    <td><asp:Label CssClass="lead" runat="server" ID="lblTotWorkingTimeProgrammed" /></td>
                    <td>

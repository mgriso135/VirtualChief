...
<asp:ImageButton runat="server" ID="imgPrintOrdiniSingolo" ImageUrl="~/img/iconBarcode.png" Height="40" OnClick="imgPrintOrdiniSingolo_Click" ToolTip="<%$Resources:lblStampaFogliSingoliA4 %>" />
          ...
          <br />
<asp:ImageButton runat="server" ID="imgPrintOrdiniSingoloA3" ImageUrl="~/img/iconA3.gif" Height="40" CommandName="printOrdiniSingoloA3" OnClick="imgPrintOrdiniSingoloA3_Click" ToolTip="<%$Resources:lblStampaFogliSingoliA3 %>" />

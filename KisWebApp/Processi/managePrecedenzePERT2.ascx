...
<asp:Image ID="Image1" runat="server" ImageUrl="~/img/iconDelete.png" style="min-width:30px; max-width:30px;" /></a>
<%#DataBinder.Eval(Container.DataItem, "NearTaskName") %>&nbsp;(<%#DataBinder.Eval(Container.DataItem, "ConstraintTypeDesc") %>)
</ItemTemplate>
...
<asp:Image ID="Image2" runat="server" ImageUrl="~/img/iconDelete.png" style="min-width:30px; max-width:30px;" /></a>
<%#DataBinder.Eval(Container.DataItem, "NearTaskName") %>&nbsp;(<%#DataBinder.Eval(Container.DataItem, "ConstraintTypeDesc") %>)
</ItemTemplate>
    <FooterTemplate></FooterTemplate>
</asp:Repeater>
...
<asp:Literal runat="server" ID="litTaskPrec"  Text="<%$Resources:litTaskPrec %>" />

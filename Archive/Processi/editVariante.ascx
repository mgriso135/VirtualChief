...
<table runat="server" id="frmEditVariante" style="border-left: 1px dashed green; border-right: 1px dashed green; border-top: 1px dashed green;  border-bottom:1px dashed green;">
    <tr>
        <td><asp:Literal runat="server" ID="lblExternalID" Text="<%$Resources:lblExternalID %>" />:</td>
        <td><asp:TextBox runat="server" ID="txtExternalID" /></td>
         <td rowspan="3">
    ...
    <tr>
        ...
        <td><asp:DropDownList ID="ddlMeasurementUnits" runat="server">
            </asp:DropDownList></td>
    </tr>
</table>
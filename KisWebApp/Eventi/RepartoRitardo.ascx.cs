...
{
    public partial class RepartoRitardo : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            prmUser[0] = "Reparto EventoRitardo";
            prmUser[1] = "W";
            ...
            if (checkUser == true)
            {
                ...
                if (!Page.IsPostBack)
                {
                    ConfigurazioneRitardoReparto cfgRp = new ConfigurazioneRitardoReparto(Session["ActiveWorkspace_Name"].ToString(), idReparto);

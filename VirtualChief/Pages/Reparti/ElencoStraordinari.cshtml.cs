...
{
    public class ElencoStraordinariModel : PageModel
    {
        private readonly ILogger<ElencoStraordinariModel> _logger;

        public ElencoStraordinariModel(ILogger<ElencoStraordinariModel> logger)
        {
            _logger = logger;
        }
        ...
        public string NavElencoStraordinari { get; private set; } = "Elenco Straordinari";
        ...
        public void OnGet(int id)
        {
            ...
            try
            {
                ...
                if (int.TryParse(uidStr, out var uid))
                {
                    ...
                    if (!HasPermission)
                    {
                        ErrorMessage = "Non hai il permesso di visualizzare gli straordinari";
                    }
                }
                else
                {
            ...
            {
                _logger.LogError(ex, "ElencoStraordinari/OnGet");
